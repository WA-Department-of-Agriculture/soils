...
if (requireNamespace("downloadthis", quietly = TRUE)) {
  list(
    ...
    downloadthis::download_this(
      output_name = glue::glue("{params$year}_soils-data"),
