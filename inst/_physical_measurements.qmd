...
![Figure showing size comparisons of soil particles (sand, silt, and clay) to common circular items (basketball, golf ball, and poppy seed)](images/texture.png){fig-alt="Texture comparison figure" width="3in"}
...
![](images/compaction.png){width="3.5in"}
...
![](images/aggregate_stability.png){width="5.8in"}
