...
If you're new to markdown syntax, see the below *selection* of examples adapted
from the [*Markdown
basics*](https://quarto.org/docs/authoring/markdown-basics.html) Quarto
documentation. Reference this primer when working through the tutorials and
...
| *italics*, **bold**, ***bold italics***                        | italics***                            |
| ```                                                            |                                       |
+----------------------------------------------------------------+---------------------------------------+
...
+-----------------------------------------------------------------------------------+--------------------------------------------------+
| ``` markdown                                                                      | ![Captio                                         |
| ![Caption](images/logo.png){width=100 fig-alt="soils logo"}                       | n](../man/figures/logo.png){fig-alt="soils logo" |
| ```                                                                               | width="100"}                                     |
+-----------------------------------------------------------------------------------+--------------------------------------------------+
