...
There are two ways to create a {soils} project in RStudio. The below examples
create a project titled "soils-demo". Replace this name with what you'd like the
project and directory to be named.

## Option 1. RStudio project wizard

Using the RStudio IDE is the easiest and recommended way to create a new {soils}
project.
...
Both options will create and launch a new RStudio project with the following
files:
