...
The below table and figures describe the functions served by each soil health
indicator; whether the measured value of an indicator should be higher (more is
better), lower (less is better), or there is an optimal range to support those
functions; and how often to measure each indicator. Soil health research is
ongoing to determine at what thresholds the soil serves the necessary ecosystem
services in different cropping systems and climates.
