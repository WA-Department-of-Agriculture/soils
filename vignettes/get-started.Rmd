...
1.  Open the `data` folder and look at the `washi-data.csv` and `data-dictionary.csv`.
...
4.  At the top of `01_producer_report.qmd`, update the `producer_id` and `year` to a valid combination that exists in your own data.

![](../man/figures/params.png){fig-alt="Lines 6-9 of 01_producer_report.qmd showing the params, producer_id, and year key-value pairs to change in the YAML."}
