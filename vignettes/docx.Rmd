...
See the original rendered report full screen in a [new tab](https://raw.githack.com/WA-Department-of-Agriculture/soils/main/inst/example_reports/example_producer_report_noManualEdits.pdf "See the original .docx report without edits in full screen."){target="_blank"}.

```{r}
knitr::include_url("https://raw.githack.com/WA-Department-of-Agriculture/soils/main/inst/example_reports/example_producer_report_noManualEdits.pdf", height = "500px")
```
