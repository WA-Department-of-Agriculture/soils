...
```{r echo=FALSE}
df <- data.frame("Qualities of a Healthy Agricultural Soil" = c(
  "•   Good soil tilth allows roots to penetrate",
...
flextable::flextable(df) |>
  flextable::color(color = header_text_color, part = "header") |> 
  flextable::bg(bg = header_color, part = "header") |>
  flextable::vline_left(border = officer::fp_border(color = header_color, width = 3)) |>
  flextable::vline_right(border = officer::fp_border(color = header_color, width = 1)) |>
  flextable::hline_bottom(border = officer::fp_border(color = header_color, width = 1)) |>
  flextable::bg(bg = lighter_color, part = "body") |>
...
::: {.content-visible when-format="html"}
::: panel-tabset
{{< include 05_physical_measurements.qmd >}}

{{< include 06_biological_measurements.qmd >}}

{{< include 07_chemical_measurements.qmd >}}
:::
:::
