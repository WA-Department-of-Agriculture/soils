...
figures, and a downloadable spreadsheet. These reports are "self-contained",
meaning all images and necessary resources are embedded in the file. As a
result, the file size can be quite large.
...
tab](https://htmlpreview.github.io/?https://github.com/WA-Department-of-Agriculture/soils/blob/44d493360e987f4ae1d6ae7cd6de5beafd045f4d/inst/example_reports/producer_report.html){target="_blank"}.

```{r echo=FALSE, out.width="100%"}
knitr::include_url(
  "https://htmlpreview.github.io/?https://github.com/WA-Department-of-Agriculture/soils/blob/44d493360e987f4ae1d6ae7cd6de5beafd045f4d/inst/example_reports/producer_report.html", height = "500px")
```
