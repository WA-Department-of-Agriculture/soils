...
# data folder, using 'example_data.Rdata' as a template. 'data_dictionary.csv' must also be updated to match your own dataset.

# load lab results

load(paste0(here(), "/data/example_data.Rdata"))

# load data dictionary for pretty labels

dictionary <- read.csv(paste0(here(), "/data/data_dictionary.csv"))
```
