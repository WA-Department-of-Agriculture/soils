---
title: "Create a New Template Project"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Create a New Template Project}
...
![Output from running `soils::create_soils()` in the RStudio console](images/create_soils.png)
