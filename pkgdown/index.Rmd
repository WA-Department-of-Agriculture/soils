...
project. Any scientist leading a soil health survey can use {soils} to create
custom reports for all survey participants. Democratize your data by giving back
to the farmers and land managers who contributed soil samples to your survey
...
and [Washington State University](https://soilhealth.wsu.edu/) produced {soils}
...
version of Quarto](https://quarto.org/docs/get-started/).
