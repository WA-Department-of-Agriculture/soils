...
**bold** are required to have values.
...
dictionary only contains `pH`. Either add this measurement to your dictionary,
or remove this measurement column from your data.

If you have additional columns in your data that aren't soil measurements,
include them in the `required_cols` vector of the [`data-validation` chunk].
...
chunks in `01_producer-report.qmd`.
