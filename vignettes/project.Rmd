...
There are two ways to create a {soils} project in RStudio. The below examples create a project titled "soils-demo". Replace this name with what you'd like the project and directory to be named.

## Option 1. RStudio project wizard

Using the RStudio IDE is the easiest and recommended way to create a new {soils} project.

`Open RStudio` \> `File` \> `New Project` \> `New Directory` \> **`Quarto Soil Health Report`**

![](../man/figures/project_wizard-1.png){width="70%" fig-alt="Screenshot of RStudio New Project Wizard with Quarto Soil Health Report selected."}
...
![](../man/figures/project_wizard-2.png){width="70%" fig-alt="Screenshot of RStudio New Project Wizard for Quarto Soil Health Report. Enter directory name, path, and check whether you want the project to open in a new RStudio session."}

The new RStudio project will open with the template Quarto report (`01_producer-report.qmd`) and the R script (`render-reports.R`) to render all reports at once. The rest of the project files will appear in the files pane.
