...
Divs start with a fence containing at least three consecutive colons (`:::`) plus some attributes in curly braces `{}`. Another line containing a string of at least three consecutive colons ends the Div. The Div should be separated by blank lines from preceding and following blocks. Divs may also be nested, as shown below.
...
``` markdown
[Purple]{style="color:purple"} is my favorite color.
```
...
Learn more in the article on [Divs and Spans](https://quarto.org/docs/authoring/markdown-basics.html#divs-and-spans).
