...
`soils` gives you an RStudio project template with everything you need to generate custom HTML and Word doc reports for each participant in your soil health survey.
...
-   [MS Word](https://wa-department-of-agriculture.github.io/soils/articles/docx.html)
