...
If you're new to markdown syntax, see the below *selection* of examples adapted from the [*Markdown basics Quarto documentation*](https://quarto.org/docs/authoring/markdown-basics.html). Reference this primer when working through the tutorials and editing the report content.
...
| ![Caption](images/logo.              |                                                                       |
| png){width=100 fig-alt="soils logo"} |                                                                       |
| ```                                  |                                                                       |
+--------------------------------------+-----------------------------------------------------------------------+
