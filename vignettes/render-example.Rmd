...
Before modifying the data, report content, or style, render the example report
with the anonymized built-in data to ensure your system is set up correctly.
