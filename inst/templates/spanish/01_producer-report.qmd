...
dictionary <- soils::sync_dictionary_texture(data, dictionary, "Spanish")
```
...
# Convert measurement columns to numeric; warns if values are converted to NA
