...
Note for Mac OS users: facetted `{plotly}` strip plots have issues with the default theme settings. Try modifying the `panel_spacing` arguments as described in the `make_plotly()` [documentation](https://wa-department-of-agriculture.github.io/soils/reference/make_plotly.html).
