...
green <- washi::washi_pal[["standard"]][["green"]]

washi::washi_flextable(df, border_color = NA) |>
  flextable::vline_left(border = officer::fp_border(color = green, width = 3)) |>
  flextable::vline_right(border = officer::fp_border(color = green, width = 1)) |>
  flextable::hline_bottom(border = officer::fp_border(color = green, width = 1)) |>
  flextable::bg(bg = "#F2F0E6") |>
...
::: {.content-visible when-format="html"}
::: panel-tabset
{{< include _03_physical_measurements.qmd >}}

{{< include _04_biological_measurements.qmd >}}

{{< include _05_chemical_measurements.qmd >}}
:::
:::
